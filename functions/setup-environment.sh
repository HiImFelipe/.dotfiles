...
function setup_environment() {
    ...
    then
        echo "Setting up core applications"
        ...
        echo "Core applications were properly configured!"
    fi

    if [[ install_options[1] -eq 1 || install_options[3] -eq 1 ]]
    then
        echo "Setting up work applications"
        ...
        echo "Work applications were properly configured!"
    fi
}